...
// Credits to team 7303 RoboAvatars, adjusted by team 3954 Pink to the Future, adjusted again by team 18710 Stanislas Tech Team
...
public class YellowPipeline extends OpenCvPipeline {
    ...
    public YellowPipeline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            // Draw Contours
            Imgproc.drawContours(processed, contours, -1, new Scalar(255, 0, 0));
            ...
            synchronized (sync) {
                ...
                for (MatOfPoint contour : contours) {
                    ...
                    if (contourArray.length >= 15) {
                        ...
                        Imgproc.rectangle(processed, rect, new Scalar(255,0,0), 2);
                        Imgproc.putText(processed, "(" + rectValue + ")", new Point(rect.x, rect.y), 0, 0.6, new Scalar(255, 255, 255), 2);
...
//                        }
                ...
                if (contours.isEmpty()) {
                    maxRect = new Rect(300,1,1,1);
                }

            }

            // Draw Rectangles If Area Is At Least 250
//            if (first && maxRect.area() > 250) {
