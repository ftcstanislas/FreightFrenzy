...
@Autonomous(group = "autonomous", name = "Autonomous Left Merlijn battery not full")
public class AutonomousLeftbatterijNotFull extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory Traj1 = drive.trajectoryBuilder(new Pose2d())
                .strafeTo(new Vector2d(5, 42.5))
                .build();
        Trajectory Traj2 = drive.trajectoryBuilder(Traj1.end())
                .strafeTo(new Vector2d(14,42.5))
                .build();
        Trajectory Traj3 = drive.trajectoryBuilder(Traj2.end())
                .strafeTo(new Vector2d(-7, 42.5))
                .build();
