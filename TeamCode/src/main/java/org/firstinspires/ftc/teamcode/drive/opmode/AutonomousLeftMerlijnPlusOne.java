...
import static org.firstinspires.ftc.teamcode.robotParts.Arm.ArmHeight.STACK5;
...
@Autonomous(group = "autonomous", name = "Autonomous Left Merlijn +1")
public class AutonomousLeftMerlijnPlusOne extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory Traj5 = drive.trajectoryBuilder(Traj4.end())
                .lineToLinearHeading(new Pose2d(-2, 60, Math.toRadians(230)))
                .build();
